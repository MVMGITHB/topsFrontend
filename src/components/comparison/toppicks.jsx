    ...
    <div className="bg-white text-black py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-20">
        <div className="mb-8">
          ...
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl">Our Top 3 Picks</h2>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {topPicks.map((app, i) => (
            <div
              key={i}
              className="relative bg-white border border-gray-200 rounded-2xl p-6 shadow-xl transition hover:scale-105"
            >
              {i === 0 && (
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                />
                <h3 className="text-xl font-semibold">{app.websiteName}</h3>
              </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm rounded-md border border-gray-300 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>
        ...
        <div className="hidden md:block">
          <table className="w-full text-sm text-left text-gray-700 shadow-md rounded-xl overflow-hidden">
                ...
                <tr key={index} className="bg-white border-b hover:bg-gray-50 transition">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1 text-yellow-500 text-sm">
                      ...
                      <span className="ml-1 text-gray-800">{card?.rating.toFixed(1)}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <Link
                      href={card.visitSiteUrl}
                      className="text-white bg-blue-600 hover:bg-blue-700 text-sm font-semibold px-4 py-2 rounded-lg shadow"
                    >
                      Visit Site
                    </Link>
                  </td>
