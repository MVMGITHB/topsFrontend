...
export default function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!agreed) {
      alert(
        "Please agree to the Privacy Policy and Terms of Use before submitting."
      );
      return;
    }
    ...
    <>
      ...
      <div className="min-h-screen bg-white text-black flex flex-col items-center justify-center p-8">
        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-700">
              <div className="flex items-center space-x-3">
                <span>📧</span>
                <span>contact@top5shots.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <span>📍</span>
          ...
          <form
            className="space-y-6 bg-gray-100 p-8 rounded-lg shadow"
