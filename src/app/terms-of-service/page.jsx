export async function generateMetadata() {
  return {
    ...
    alternates: {
      canonical: "https://www.top5shots.com/terms-of-service",
    },
  };
}
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-10">
      ...
      <div className="space-y-8 text-gray-700 text-base leading-relaxed">
        <p>
          Welcome to Top5Shots! By accessing or using our platform, you agree to
        ...
        <section>
          ...
          <p>
            You agree to use Top5Shots only for lawful purposes and in a manner
        ...
        <section>
          ...
          <p>
            All content you post remains yours, but by submitting it to
            Top5Shots, you grant us a non-exclusive license to use it in
        ...
        <section>
          ...
          <p>
            ...
            login information and all activities under your account.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Top5Shots at any time for violation of these Terms.
          </p>
        </section>
